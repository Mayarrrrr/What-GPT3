...
const Blog = () => (
  <div className="gpt3__blog section__padding" id="blog">
    ...
    {/* h2smhom 2 gps 3shan wa7d hyb2a col w al tanyen grid */}
      <div className="gpt3__blog-container_groupA scale-in-center">     
        <Article imgUrl={blog01} date="Sep 26, 2021" text="GPT-3 and Open  AI is the future. Let us exlore how it is?" />
      </div>

      <div className="gpt3__blog-container_groupB scale-in-ver-center">
